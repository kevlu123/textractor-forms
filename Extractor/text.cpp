...
const char* ATTACH = "Attach to game";
const char* LAUNCH = "Launch game";
const char* CONFIG = "Configure game";
const char* DETACH = "Detach from game";
const char* FORGET = "Forget game";
const char* ADD_HOOK = "Add hook";
const char* REMOVE_HOOKS = "Remove hook(s)";
const char* SAVE_HOOKS = "Save hook(s)";
const char* SEARCH_FOR_HOOKS = "Search for hooks";
const char* SETTINGS = "Settings";
const char* EXTENSIONS = "Extensions";
const char* SELECT_PROCESS = "Select process";
const char* ATTACH_INFO = R"(If you don't see the process you want to attach, try running with admin rights
You can also type in the process ID)";
const char* SELECT_PROCESS_INFO = "If you manually type in the process file name, use the absolute path";
const char* FROM_COMPUTER = "Select from computer";
const char* PROCESSES = "Processes (*.exe)";
const char* CODE_INFODUMP = R"(Enter read code
...
const char* SAVE_SETTINGS = "Save settings";
const char* EXTEN_WINDOW_INSTRUCTIONS = R"(Right click the list to add or remove extensions
Drag and drop extensions within the list to reorder them
(Extensions are used from top to bottom: order DOES matter))";
const char* ADD_EXTENSION = "Add extension";
const char* REMOVE_EXTENSION = "Remove extension";
const char* INVALID_EXTENSION = "%1 is an invalid extension";
const char* CONFIRM_EXTENSION_OVERWRITE = "Another version of this extension already exists, do you want to delete and overwrite it?";
const char* EXTENSION_WRITE_ERROR = "Failed to save extension";
const char* USE_JP_LOCALE = "Emulate japanese locale?";
const char* FAILED_TO_CREATE_CONFIG_FILE = "Failed to create config file \"%1\"";
const char* HOOK_SEARCH_UNSTABLE_WARNING = "Searching for hooks is unstable! Be prepared for your game to crash!";
const char* HOOK_SEARCH_STARTING_VIEW_CONSOLE = "Initializing hook search - please check console for further instructions";
const char* SEARCH_CJK = "Search for Chinese/Japanese/Korean";
const char* SEARCH_PATTERN = "Search pattern (hex byte array)";
const char* SEARCH_DURATION = "Search duration (ms)";
const char* SEARCH_MODULE = "Search within module";
const char* PATTERN_OFFSET = "Offset from pattern start";
const char* MAX_HOOK_SEARCH_RECORDS = "Search result cap";
const char* MIN_ADDRESS = "Minimum address (hex)";
const char* MAX_ADDRESS = "Maximum address (hex)";
const char* STRING_OFFSET = "String offset (hex)";
const char* HOOK_SEARCH_FILTER = "Results must match this regex";
const char* TEXT = "Text";
const char* CODEPAGE = "Codepage";
const char* SEARCH_FOR_TEXT = "Search for specific text";
const char* START_HOOK_SEARCH = "Start hook search";
const char* SAVE_SEARCH_RESULTS = "Save search results";
const char* TEXT_FILES = "Text (*.txt)";
const char* DOUBLE_CLICK_TO_REMOVE_HOOK = "Double click a hook to remove it";
const char* FILTER_REPETITION = "Filter repetition";
const char* AUTO_ATTACH = "Auto attach";
const char* ATTACH_SAVED_ONLY = "Auto attach (saved only)";
const char* SHOW_SYSTEM_PROCESSES = "Show system processes";
const char* DEFAULT_CODEPAGE = "Default codepage";
const char* FLUSH_DELAY = "Flush delay";
const char* MAX_BUFFER_SIZE = "Max buffer size";
const char* MAX_HISTORY_SIZE = "Max history size";
const char* CONFIG_JP_LOCALE = "Launch with JP locale";
...
const char* PIPE_CONNECTED = "Textractor: pipe connected";
const char* INSERTING_HOOK = "Textractor: inserting hook: %s";
const char* REMOVING_HOOK = "Textractor: removing hook: %s";
const char* HOOK_FAILED = "Textractor: failed to insert hook";
const char* TOO_MANY_HOOKS = "Textractor: too many hooks: can't insert";
const char* HOOK_SEARCH_STARTING = "Textractor: starting hook search";
const char* HOOK_SEARCH_INITIALIZING = "Textractor: initializing hook search (%f%%)";
const char* NOT_ENOUGH_TEXT = "Textractor: not enough text to search accurately";
const char* HOOK_SEARCH_INITIALIZED = "Textractor: initialized hook search with %zd hooks";
const char* MAKE_GAME_PROCESS_TEXT = "Textractor: please click around in the game to force it to process text during the next %d seconds";
const char* HOOK_SEARCH_FINISHED = "Textractor: hook search finished, %d results found";
const char* OUT_OF_RECORDS_RETRY = "Textractor: out of search records, please retry if results are poor (default record count increased)";
const char* FUNC_MISSING = "Textractor: function not present";
const char* MODULE_MISSING = "Textractor: module not present";
const char* GARBAGE_MEMORY = "Textractor: memory constantly changing, useless to read";
const char* SEND_ERROR = "Textractor: Send ERROR (likely an unstable/incorrect H-code)";
const char* READ_ERROR = "Textractor: Reader ERROR (likely an incorrect R-code)";
const char* HIJACK_ERROR = "Textractor: Hijack ERROR";
const char* COULD_NOT_FIND = "Textractor: could not find text";
const char* TRANSLATE_TO = "Translate to";
const char* TRANSLATE_FROM = "Translate from";
const char* FILTER_GARBAGE = "Filter garbage characters";
const char* TRANSLATE_SELECTED_THREAD_ONLY = "Translate selected text thread only";
const char* RATE_LIMIT_ALL_THREADS = "Use rate limiter";
const char* RATE_LIMIT_SELECTED_THREAD = "Rate limit selected text thread";
const char* USE_TRANS_CACHE = "Use translation cache";
const char* MAX_TRANSLATIONS_IN_TIMESPAN = "Max translation requests in timespan";
const char* TIMESPAN = "Timespan (ms)";
...
const char* USE_PREV_SENTENCE_CONTEXT = "Use previous sentence as context";
const char* API_KEY = "API key";
const char* CHROME_LOCATION = "Google Chrome file location";
const char* START_DEVTOOLS = "Start DevTools";
const char* STOP_DEVTOOLS = "Stop DevTools";
const char* HIDE_CHROME = "Hide Chrome window";
const char* DEVTOOLS_STATUS = "DevTools status";
const char* AUTO_START = "Start automatically";
const wchar_t* ERROR_START_CHROME = L"failed to start Chrome or to connect to it";
const char* EXTRA_WINDOW_INFO = R"(Right click to change settings
Click and drag on window edges to move, or the bottom right corner to resize)";
const char* MAX_SENTENCE_SIZE = "Max sentence size";
const char* TOPMOST = "Always on top";
const char* DICTIONARY = "Dictionary";
const char* DICTIONARY_INSTRUCTIONS = R"(This file is used only for the "Dictionary" feature of the Extra Window extension.
...
const char* SHOW_ORIGINAL = "Original text";
const char* SHOW_ORIGINAL_INFO = R"(Original text will not be shown
Only works if this extension is used directly after a translation extension)";
const char* ORIGINAL_AFTER_TRANSLATION = "Original text after translation";
const char* SIZE_LOCK = "Size lock";
const char* POSITION_LOCK = "Position lock";
const char* CENTERED_TEXT = "Centered text";
const char* AUTO_RESIZE_WINDOW_HEIGHT = "Auto resize window height";
const char* CLICK_THROUGH = "Click through\tAlt+X";
const char* HIDE_MOUSEOVER = "Hide while mouse on top";
const char* OPACITY = "Opacity";
const char* BG_COLOR = "Background color";
const char* TEXT_COLOR = "Text color";
const char* TEXT_OUTLINE = "Text outline";
const char* OUTLINE_COLOR = "Outline color";
const char* OUTLINE_SIZE = "Outline size";
const char* OUTLINE_SIZE_INFO = "Size in pixels (recommended to stay below 20% of the font size)";
const char* FONT = "Font";
const char* LUA_INTRO = R"(--[[
...
const char* LOAD_SCRIPT = "Load script";
const wchar_t* LUA_ERROR = L"Lua error: %s";
const char* REGEX_FILTER = "Regex Filter";
const char* INVALID_REGEX = "Invalid regex";
const char* CURRENT_FILTER = "Currently filtering: %1";
...
const char* THREAD_LINKER = "Thread Linker";
const char* LINK = "Link";
const char* UNLINK = "Unlink";
const char* THREAD_LINK_FROM = "Thread number to link from";
const char* THREAD_LINK_TO = "Thread number to link to";
const char* HEXADECIMAL = "Hexadecimal";

void Localize() {
#ifdef TURKISH
	NATIVE_LANGUAGE = "Turkish";
	ATTACH = "Oyuna bağla";
	DETACH = "Oyundan kopar";
	ADD_HOOK = "Kanca ekle";
	SAVE_HOOKS = "Kancaları kaydet";
	SETTINGS = "Ayarlar";
	EXTENSIONS = "Uzantılar";
	SELECT_PROCESS = "İşlem seçin";
	ATTACH_INFO = "Bağlanmak istediğiniz işlemi görmüyorsanız yönetici olarak çalıştırmayı deneyin";
	DEFAULT_CODEPAGE = "Varsayılan Kod Sayfası";
	FLUSH_DELAY = "Temizleme Gecikmesi";
	MAX_BUFFER_SIZE = "Maksimum Arabellek Boyu";
...
Kaynak kodu GKLv3 koruması altında proje ana sayfasında mevcut)";
	...
	PIPE_CONNECTED = "Textractor: Boru bağlandı";
	INSERTING_HOOK = "Textractor: Kanca ekleniyor: %s";
	REMOVING_HOOK = "Textractor: Kanca çıkarılıyor:: %s";
	HOOK_FAILED = "Textractor: Kanca eklenemedi";
	TOO_MANY_HOOKS = "Textractor: Çok fazla kanca var: Eklenemiyor";
	FUNC_MISSING = "Textractor: Fonksiyon mevcut değil";
	MODULE_MISSING = "Textractor: Modül mevcut değil";
	GARBAGE_MEMORY = "Textractor: Hafıza sürekli değişiyor, okumak boşa";
#endif // TURKISH

#ifdef SPANISH
	NATIVE_LANGUAGE = "Spanish";
	ATTACH = "Adjuntar juego";
	LAUNCH = "Iniciar juego";
	DETACH = "Desconectar juego";
	ADD_HOOK = "Añadir hook";
	SAVE_HOOKS = "Guardar hook(s)";
	SETTINGS = "Opciones";
	EXTENSIONS = "Extensiones";
	SELECT_PROCESS = "Seleccionar procreso";
	ATTACH_INFO = R"(Si no ves el proceso que quieras adjuntar, ejecuta este programa como administrador
También puedes escribir la ID del proceso)";
	FROM_COMPUTER = "Seleccionar desde computadora";
	PROCESSES = "Procesos (*.exe)";
	SAVE_SETTINGS = "Guardar opciones";
	EXTEN_WINDOW_INSTRUCTIONS = R"(Arrrastra y suelta la extension (.dll) aquí desde tu computadora para añadirlos
Arrastra y suelta la lista para reordenar
Presiona supr en una extension seleccionada para removerla)";
	USE_JP_LOCALE = "¿Emular idioma japonés?";
	DEFAULT_CODEPAGE = "Default Codepage";
...
Código fuente disponible bajo GPLv3 en la página del proyecto)";
	...
	PIPE_CONNECTED = "Textractor: pipe connected";
	INSERTING_HOOK = "Textractor: insertando hook: %s";
	REMOVING_HOOK = "Textractor: removiendo hook: %s";
	HOOK_FAILED = "Textractor: no se puede insertar hook";
	TOO_MANY_HOOKS = "Textractor: demasiados hooks: no se puede insertar";
	NOT_ENOUGH_TEXT = "Textractor: no hay suficiente texto para buscar con precisión";
	FUNC_MISSING = "Textractor: función no presente";
	MODULE_MISSING = "Textractor: module not present";
	GARBAGE_MEMORY = "Textractor: memory constantly changing, useless to read";
	SEND_ERROR = "Textractor: Send ERROR (probablemente un H-code incorrecto)";
	READ_ERROR = "Textractor: Reader ERROR (probablemente un R-code incorrecto)";
	HIJACK_ERROR = "Textractor: Hijack ERROR";
	COULD_NOT_FIND = "Textractor: no se puede encontrar texto";
	TOO_MANY_TRANS_REQUESTS = L"Demasiadas peticiones de traducción: no se puede hacer más";
	TRANSLATION_ERROR = L"Error al traducir";
	EXTRA_WINDOW_INFO = R"(Clic derecho para configurar
Clic y arrastra los bordes de la ventana para moverla, o en la esquina inferior derecha para cambiar el tamaño)";
	...
	CURRENT_FILTER = "Actualmente filtrando: %1";
#endif // SPANISH
	...
	REMOVE_HOOKS = "移除钩子";
	SAVE_HOOKS = "保存钩子";
	SEARCH_FOR_HOOKS = "搜索钩子";
	SETTINGS = "设置";
	EXTENSIONS = "扩展";
	SELECT_PROCESS = "选择进程";
	ATTACH_INFO = R"(如果没看见想要附加的进程，尝试使用管理员权限运行
也可以手动输入进程ID)";
	SELECT_PROCESS_INFO = "如果手动输入游戏名，请使用绝对路径";
	FROM_COMPUTER = "从计算机中选择";
	PROCESSES = "进程 (*.exe)";
	SAVE_SETTINGS = "保存设置";
	EXTEN_WINDOW_INSTRUCTIONS = R"(从计算机拖拽扩展 (.dll) 文件到这里来添加
(如果使用超级管理员运行，则无法工作)
在列表中拖拽来重新排序
使用 delete 键移除选中的扩展)";
	ADD_EXTENSION = "添加扩展";
	INVALID_EXTENSION = "%1 是一个无效扩展";
	CONFIRM_EXTENSION_OVERWRITE = "此扩展的另一个版本已启用，是否删除并覆盖它?";
	EXTENSION_WRITE_ERROR = "保存扩展失败";
	USE_JP_LOCALE = "模拟日本区域设置?";
	HOOK_SEARCH_UNSTABLE_WARNING = "搜索钩子的功能是不稳定的! 可能会导致你的游戏崩溃! ";
	SEARCH_CJK = "搜索中文/日文/韩文";
	SEARCH_PATTERN = "搜索匹配特征 (hex byte array)";
	SEARCH_DURATION = "搜索持续时间 (ms)";
	SEARCH_MODULE = "搜索指定模块";
	PATTERN_OFFSET = "相对于特征地址的偏移值";
	MAX_HOOK_SEARCH_RECORDS = "搜索结果上限";
	MIN_ADDRESS = "起始地址 (hex)";
	MAX_ADDRESS = "结束地址 (hex)";
	STRING_OFFSET = "字符串偏移值 (hex)";
	HOOK_SEARCH_FILTER = "结果必须匹配的正则表达式";
	TEXT = "文本";
	CODEPAGE = "代码页";
	SEARCH_FOR_TEXT = "搜索指定文本";
	START_HOOK_SEARCH = "开始搜索钩子";
	SAVE_SEARCH_RESULTS = "保存搜索结果";
	TEXT_FILES = "文本文档 (*.txt)";
	DOUBLE_CLICK_TO_REMOVE_HOOK = "双击移除不需要的钩子";
	FILTER_REPETITION = "过滤重复文本";
	AUTO_ATTACH = "自动附加";
	ATTACH_SAVED_ONLY = "自动附加 (saved only)";
	SHOW_SYSTEM_PROCESSES = "显示系统进程";
	DEFAULT_CODEPAGE = "默认代码页";
	FLUSH_DELAY = "刷新延迟";
	MAX_BUFFER_SIZE = "最大缓冲区长度";
	MAX_HISTORY_SIZE = "最大缓存文本长度";
	CONFIG_JP_LOCALE = "模拟日本区域启动游戏";
	CONSOLE = L"控制台";
	CLIPBOARD = L"剪贴板";
...
项目主页提供基于 GPLv3 协议的源代码)";
	...
	PIPE_CONNECTED = "Textractor: 管道已连接";
	INSERTING_HOOK = "Textractor: 注入钩子: %s";
	REMOVING_HOOK = "Textractor: 移除钩子: %s";
	HOOK_FAILED = "Textractor: 钩子注入失败";
	TOO_MANY_HOOKS = "Textractor: 钩子数量已达上限: 无法注入";
	HOOK_SEARCH_STARTING = "Textractor: 开始搜索钩子";
	NOT_ENOUGH_TEXT = "Textractor: 没有足够的文本用来精确搜索";
	HOOK_SEARCH_INITIALIZED = "Textractor: 搜索初始化完成, 创建了 %zd 个钩子";
	MAKE_GAME_PROCESS_TEXT = "Textractor: 请点击游戏区域, 在接下来的 %d 秒内使游戏强制处理文本";
	HOOK_SEARCH_FINISHED = "Textractor: 钩子搜索完毕, 找到了 %d 条结果";
	OUT_OF_RECORDS_RETRY = "Textractor: 搜索结果已达上限, 如果结果不理想, 请重试(默认最大记录数增加)";
	FUNC_MISSING = "Textractor: 函数不存在";
	MODULE_MISSING = "Textractor: 模块不存在";
	GARBAGE_MEMORY = "Textractor: 内存一直在变，读了也没用";
	SEND_ERROR = "Textractor: Sender 错误 (H码可能不正确)";
	READ_ERROR = "Textractor: Reader 错误 (R码可能不正确)";
	HIJACK_ERROR = "Textractor: Hijack 错误";
	COULD_NOT_FIND = "Textractor: 无法找到文本";
	TRANSLATE_TO = "翻译为";
	TRANSLATE_SELECTED_THREAD_ONLY = "仅翻译当前选择的文本线程";
	RATE_LIMIT_ALL_THREADS = "限制所有文本线程的请求频率";
	RATE_LIMIT_SELECTED_THREAD = "限制当前选择线程的请求频率";
	USE_TRANS_CACHE = "使用缓存的翻译结果";
	MAX_TRANSLATIONS_IN_TIMESPAN = "限流器令牌数";
	TIMESPAN = "限流器令牌重置时间 (ms)";
	TOO_MANY_TRANS_REQUESTS = L"太多翻译请求: 拒绝生成更多";
	TRANSLATION_ERROR = L"翻译时出错";
	USE_PREV_SENTENCE_CONTEXT = "使用之前的句子作为上下文";
	API_KEY = "API key";
	EXTRA_WINDOW_INFO = R"(右键修改设置
在窗口边缘点击并拖拽来移动，或在右下角点击并拖拽来调整大小)";
	MAX_SENTENCE_SIZE = "最大文本长度";
	TOPMOST = "窗口总是置顶";
	DICTIONARY = "字典";
	SHOW_ORIGINAL = "显示原文";
	SHOW_ORIGINAL_INFO = R"(将不显示原文
仅当此扩展置于翻译扩展之后使用时才有效)";
	OPACITY = "透明度";
	SIZE_LOCK = "锁定窗口大小";
	BG_COLOR = "背景颜色";
	...
	OUTLINE_COLOR = "边框颜色";
	OUTLINE_SIZE = "边框大小";
	OUTLINE_SIZE_INFO = "以像素为单位的大小(建议保持在字体大小的20%以下)";
	FONT = "字体";
	LUA_INTRO = R"(--[[
...
function ProcessSentence(sentence, sentenceInfo)
  --在此处添加你的代码...
	...
	LOAD_SCRIPT = "加载脚本";
	LUA_ERROR = L"Lua 错误";
	REGEX_FILTER = "正则表达式过滤器";
	INVALID_REGEX = "无效的正则表达式";
	CURRENT_FILTER = "当前过滤中: %1";
...
此文件必须使用Unicode字符集(UTF-16 little endian).)";
	THREAD_LINKER = "线程链接器";
	LINK = "链接";
	THREAD_LINK_FROM = "需要链接的线程id";
	THREAD_LINK_TO = "链接到的线程id";
	HEXADECIMAL = "十六进制";
#endif // SIMPLIFIED_CHINESE

#ifdef RUSSIAN
	NATIVE_LANGUAGE = "Russian";
	ATTACH = "Присоединить к игре";
	LAUNCH = "Запустить игру";
	CONFIG = "Настройки игры";
	DETACH = "Отсоединить от игры";
	FORGET = "Забыть игру";
	ADD_HOOK = "Добавить хук";
	REMOVE_HOOKS = "Удалить хук(и)";
	SAVE_HOOKS = "Сохранить хук(и)";
	SEARCH_FOR_HOOKS = "Найти хуки";
	SETTINGS = "Настройки";
	EXTENSIONS = "Расширения";
	SELECT_PROCESS = "Выберете процесс";
	ATTACH_INFO = R"(Если вы не видите процесс, к которому хотите присоединить, попробуйте запуск с правами администратора
Вы также можете ввести ID процесса)";
	SELECT_PROCESS_INFO = "При ручном вводе имени файла процесса используйте абсолютный путь";
	FROM_COMPUTER = "Найти в проводнике";
	PROCESSES = "Процессы (*.exe)";
	CODE_INFODUMP = R"(Введите код чтения
R{S|Q|V|M}[null_length<][codepage#]@addr
ИЛИ
Введите хук-код
H{A|B|W|H|S|Q|V|M}[F][null_length<][N][codepage#][padding+]data_offset[*deref_offset][:split_offset[*deref_offset]]@addr[:module[:func]]
...
* значит указатель разницы+deref_offset)";
	...
	EXTEN_WINDOW_INSTRUCTIONS = R"(Перетащите сюда (.dll) файлы расширений из проводника для их добавления
...
Нажмите клавишу удаления, чтобы удалить выбранное расширение)";
	...
	INVALID_EXTENSION = "%1 - неверное расширение";
	CONFIRM_EXTENSION_OVERWRITE = "Уже существует другая версия этого расширения, перезаписать его?";
	EXTENSION_WRITE_ERROR = "Не удалось сохранить расширение";
	USE_JP_LOCALE = "Симулировать японскую локаль?";
	FAILED_TO_CREATE_CONFIG_FILE = "Не удалось создать файл настроек \"%1\"";
	HOOK_SEARCH_UNSTABLE_WARNING = "Поиск хуков нестабилен! Игра может закрыться с ошибкой!";
	SEARCH_CJK = "Поиск для Китайского/Японского/Корейского";
	SEARCH_PATTERN = "Шаблон поиска (hex byte array)";
	SEARCH_DURATION = "Продолжительность поиска (ms)";
	SEARCH_MODULE = "Поиск по модулю";
	PATTERN_OFFSET = "Смещение от начала шаблона";
	MAX_HOOK_SEARCH_RECORDS = "Порог поиска";
	MIN_ADDRESS = "Начальный адрес (hex)";
	MAX_ADDRESS = "Конечный адрес (hex)";
	STRING_OFFSET = "Смещение строки (hex)";
	HOOK_SEARCH_FILTER = "Результат должен совпадать с этим regex";
	TEXT = "Текст";
	CODEPAGE = "Кодировка";
	SEARCH_FOR_TEXT = "Поиск определенного текста";
	START_HOOK_SEARCH = "Начать поиск хуков";
	SAVE_SEARCH_RESULTS = "Сохранить результат поиска";
	TEXT_FILES = "Текст (*.txt)";
	DOUBLE_CLICK_TO_REMOVE_HOOK = "Двойной клик по хуку для его удаления";
	FILTER_REPETITION = "Фильтр повторений";
	AUTO_ATTACH = "Авто-присоединение";
	ATTACH_SAVED_ONLY = "Авто-присоединение (только сохраненные)";
	SHOW_SYSTEM_PROCESSES = "Показать системные процесы";
	DEFAULT_CODEPAGE = "Кодировка по умолчанию";
	FLUSH_DELAY = "Задержка сброса";
	MAX_BUFFER_SIZE = "Максимальный размер буфера";
	MAX_HISTORY_SIZE = "Макс. размер истории";
	CONFIG_JP_LOCALE = "Запуск с JP локалью";
	CONSOLE = L"Консоль";
...
пример: Textractor -p4466 -p"My Game.exe" попробует присоединиться к процессу с ID 4466 или с именем My Game.exe)";
	...
	PIPE_CONNECTED = "Textractor: канал присоединен";
	INSERTING_HOOK = "Textractor: вставка хука: %s";
	REMOVING_HOOK = "Textractor: удаление хука: %s";
	HOOK_FAILED = "Textractor: не удалось вставить хук";
	TOO_MANY_HOOKS = "Textractor: слишком много хуков: невозможно вставить";
	HOOK_SEARCH_STARTING = "Textractor: начало поиска";
	NOT_ENOUGH_TEXT = "Textractor: не достаточно текста для точного поиска";
	HOOK_SEARCH_INITIALIZED = "Textractor: поиск инициализирован с %zd хуками";
	MAKE_GAME_PROCESS_TEXT = "Textractor: покликайте в игре, чтобы вызвать смену текста в течение %d секунд";
	HOOK_SEARCH_FINISHED = "Textractor: поиск хуков завершен, %d результатов найдено";
	OUT_OF_RECORDS_RETRY = "Textractor: записи для поиска закончились, повторите,если результаты неудовлетворительны (количество записей по умолчанию увеличено)";
	FUNC_MISSING = "Textractor: функция отсутствует";
	MODULE_MISSING = "Textractor: модуль отсутствует";
	GARBAGE_MEMORY = "Textractor: память постоянно изменяется, бесполезно читать";
	SEND_ERROR = "Textractor: Send ERROR (вероятно неверный H-code)";
	READ_ERROR = "Textractor: Reader ERROR (вероятно неверный R-code)";
	COULD_NOT_FIND = "Textractor: невозможно найти текст";
	TRANSLATE_TO = "Переводить на";
	TRANSLATE_SELECTED_THREAD_ONLY = "Переводить текст только в выбранном потоке";
	RATE_LIMIT_ALL_THREADS = "Ограничение скорости для всех текстовых потоков";
	RATE_LIMIT_SELECTED_THREAD = "Ограничение скорости выделенного текстового потока";
	USE_TRANS_CACHE = "Использовать кеш перевода";
	MAX_TRANSLATIONS_IN_TIMESPAN = "Ограничение частоты подсчёта токенов";
	TIMESPAN = "Ограничение частоты задержки восстановления токенов (мс)";
	TOO_MANY_TRANS_REQUESTS = L"Слишком много запросов для перевода: отклонено";
	TRANSLATION_ERROR = L"Ошибка при переводе";
	USE_PREV_SENTENCE_CONTEXT = "Использовать предыдущее предложение как контекст";
	API_KEY = "Ключ API";
	EXTRA_WINDOW_INFO = R"(Правый клик для изменения настроек
Нажмите и перетащите за края - для перемещения, или за правый-нижний угол - для изменения размера)";
	MAX_SENTENCE_SIZE = "Максимальная длина предложения";
	TOPMOST = "Поверх всех окон";
	DICTIONARY = "Словарь";
	DICTIONARY_INSTRUCTIONS = R"(Этот файл использован только для функции "Словарь" расширения Extra Window.
...
У этого файла кодировка должна быть UTF-8.)";
	SHOW_ORIGINAL = "Исходный текст";
	SHOW_ORIGINAL_INFO = R"(Исходный текст будет скрыт
Работает только если это расширение используется после расширения перевода)";
	SIZE_LOCK = "Фиксированный размер";
	OPACITY = "Прозрачность";
	BG_COLOR = "Цвет заднего фона";
	TEXT_COLOR = "Цвет текста";
	TEXT_OUTLINE = "Обводка текста";
	OUTLINE_COLOR = "Цвет обводки";
	OUTLINE_SIZE = "Толщина обводки";
	OUTLINE_SIZE_INFO = "Размер в пикселях (рекомендуется оставить как 20% от размера шрифта)";
	FONT = "Шрифт";
	LUA_INTRO = R"(--[[
...
function ProcessSentence(sentence, sentenceInfo)
  --Ваш код здесь...
	...
	REGEX_FILTER = "Фильтр Regex";
	INVALID_REGEX = "Неверный regex";
	CURRENT_FILTER = "Сейчас фильтруется: %1";
...
Этот файл должен быть в кодировке Unicode (UTF-16 little endian).)";
	THREAD_LINKER = "Связыватель нитей";
	LINK = "Связь";
	THREAD_LINK_FROM = "Номер нити, от которой связывать";
	THREAD_LINK_TO = "Номер нити, к которой привязывать";
#endif // RUSSIAN

#ifdef INDONESIAN
	NATIVE_LANGUAGE = "Indonesian";
	ATTACH = "Tempelkan kedalam game";
	LAUNCH = "Mulai game";
	DETACH = "Lepaskan dari game";
	ADD_HOOK = "Tambahkan hook";
	SAVE_HOOKS = "Simpan hook";
	SETTINGS = "Pengaturan";
	EXTENSIONS = "Ekstensi";
	SELECT_PROCESS = "Pilih Proses";
	ATTACH_INFO = R"(Jika kamu tidak dapat melihat proses yang akan ditempelkan, coba menjalankan dengan mode administrator
Kamu juga dapat mengetik process ID game yang akan ditempel)";
	FROM_COMPUTER = "Pilih dari komputer";
	PROCESSES = "Proses (*.exe)";
	SAVE_SETTINGS = "Simpan pengaturan";
	EXTEN_WINDOW_INSTRUCTIONS = R"(Drag and drop file ekstensi (.dll) kedalam sini dari komputer kamu untuk menambah ekstensi
...
Tekan delete pada ekstensi yang dipilih untuk menghapus ekstensi)";
	USE_JP_LOCALE = "Gunakan locale jepang?";
	DEFAULT_CODEPAGE = "Codepage standar";
	FLUSH_DELAY = "Flush Delay";
	MAX_BUFFER_SIZE = "Max Buffer Size";
	CONSOLE = L"Konsol";
...
Jika kamu menyukai project ini, tolong sebarluaskan project ini :))";
	...
	PIPE_CONNECTED = "Textractor: pipe tersambung";
	INSERTING_HOOK = "Textractor: memasukkan hook: %s";
	REMOVING_HOOK = "Textractor: menghapus hook: %s";
	HOOK_FAILED = "Textractor: gagal memasukkan hook";
	TOO_MANY_HOOKS = "Textractor: terlalu banyak hook: tidak dapat memasukkan hook";
	NOT_ENOUGH_TEXT = "Textractor: tidak cukup teks untuk melakukan pencarian secara akurat";
	FUNC_MISSING = "Textractor: tidak ada fungsi";
	MODULE_MISSING = "Textractor: tidak ada modul";
	GARBAGE_MEMORY = "Textractor: memory terus berganti, tidak dapat dibaca";
	SEND_ERROR = "Textractor: Send ERROR (kemungkinan H-Code salah)";
	READ_ERROR = "Textractor: Reader ERROR (Kemungkinan R-Code salah)";
	HIJACK_ERROR = "Textractor: Hijack ERROR";
	COULD_NOT_FIND = "Textractor: tidak dapat menemukan teks";
	...
	EXTRA_WINDOW_INFO = R"(Klik kanan untuk merubah pengaturan
Klik dan tarik pinggiran jendela untuk memindahkan, atau sudut kanan bawah untuk mengatur ukuran jendela)";
	...
	TOPMOST = "Selalu berada di atas";
	REGEX_FILTER = "Filter regex";
	INVALID_REGEX = "Regex tidak sesuai";
	CURRENT_FILTER = "Regex yang digunakan sekarang: %1";
#endif // INDONESIAN

#ifdef ITALIAN
	NATIVE_LANGUAGE = "Italian";
	ATTACH = "Collega al gioco";
	LAUNCH = "Avvia gioco";
	CONFIG = "Configura gioco";
	DETACH = "Scollega dal gioco";
	FORGET = "Dimentica gioco";
	ADD_HOOK = "Aggiungi gancio";
	REMOVE_HOOKS = "Rimuovi gancio/ci";
	SAVE_HOOKS = "Salva gancio/ci";
	SEARCH_FOR_HOOKS = "Ricerca ganci";
	SETTINGS = "Impostazioni";
	EXTENSIONS = "Estenzioni";
	SELECT_PROCESS = "Seleziona processo";
	ATTACH_INFO = R"(Se non vedi il processo che desideri allefare, prova ad eseguire come amministratore
Puoi anche digitare l'ID del processo)";
	SELECT_PROCESS_INFO = "Se digiti manualmente il nome file del processo, si prega di utilizzare il percorso assoluto";
	FROM_COMPUTER = "Seleziona dal computer";
	PROCESSES = "Processi (*.exe)";
	CODE_INFODUMP = R"(Digita il codice di lettura
R{S|Q|V|M}[null_length<][codepage#]@addr
OR
...
* significa puntatore di deferenziazione+deref_offset)";
	...
	EXTEN_WINDOW_INSTRUCTIONS = R"(Per aggiugnere un estenzione, clicca con il tasto destro la lista estenzioni
...
Per rimuovere un estenzione, selezionala e premi rimuovi)";
	ADD_EXTENSION = "Aggiungi estenzione";
	INVALID_EXTENSION = "%1 è un estenzione non valida";
	CONFIRM_EXTENSION_OVERWRITE = "Un'altra versione di questa estenzione esiste già, desidera cancellarla e sovvrascriverla?";
	EXTENSION_WRITE_ERROR = "Impossibile salvare l'estenzione";
	USE_JP_LOCALE = "Emulare l'impostazione locale giapponese?";
	FAILED_TO_CREATE_CONFIG_FILE = "Impossibile creare il file di configurazione \"%1\"";
	HOOK_SEARCH_UNSTABLE_WARNING = "Cercare i ganci è instabile! Preparati a un crash del tuo gioco!";
	SEARCH_CJK = "Cerca per Cinese/Giapponese/Coreano";
	SEARCH_PATTERN = "Cerca schema (matrice byte in esa)";
	SEARCH_DURATION = "Cerca durata (ms)";
	SEARCH_MODULE = "Cerca dentro il modulo";
	PATTERN_OFFSET = "Offset dall'inizio dello schema";
	MAX_HOOK_SEARCH_RECORDS = "Limite risultati di ricerca";
	MIN_ADDRESS = "Indirizzo minimo (esa)";
	MAX_ADDRESS = "Indirizzo massimo (esa)";
	STRING_OFFSET = "Offset stringa (esa)";
	HOOK_SEARCH_FILTER = "I risultati devono combaciare con questa espreressione regolare";
	TEXT = "Testo";
	CODEPAGE = "Codepage";
	SEARCH_FOR_TEXT = "Cerca per un testo specifico";
	START_HOOK_SEARCH = "Avvia ricerca gancio";
	SAVE_SEARCH_RESULTS = "Salva i risultati ricerca";
	TEXT_FILES = "Testo (*.txt)";
	DOUBLE_CLICK_TO_REMOVE_HOOK = "Doppio click su un gancio per rimuoverlo";
	FILTER_REPETITION = "Filtro ripetizione";
	AUTO_ATTACH = "Allega automaticamente";
	ATTACH_SAVED_ONLY = "Allega automaticamente (solamente salvato)";
	SHOW_SYSTEM_PROCESSES = "Mostra i processi di sistema";
	DEFAULT_CODEPAGE = "Codepage di base";
	FLUSH_DELAY = "Ritardo flush";
	MAX_BUFFER_SIZE = "Massima dimensione buffer";
	MAX_HISTORY_SIZE = "Massima dimensione cronologia";
	CONFIG_JP_LOCALE = "Avvia con il JP locale";
	CONSOLE = L"Console";
	CLIPBOARD = L"Appunti";
...
esempio: Textractor -p4466 -p"My Game.exe" sta tentando di inniettare i processi con l'ID 4466 o con il nome My Game.exe)";
	...
	PIPE_CONNECTED = "Textractor: tubo connesso";
	INSERTING_HOOK = "Textractor: aggiungi gancio: %s";
	REMOVING_HOOK = "Textractor: rimuovi gancio: %s";
	HOOK_FAILED = "Textractor: inserimento gancio non riuscito";
	TOO_MANY_HOOKS = "Textractor: troppi ganci: impossibile inserirli";
	HOOK_SEARCH_STARTING = "Textractor: avvia la ricerca";
	NOT_ENOUGH_TEXT = "Textractor: testo insufficente per la ricerca accurata";
	HOOK_SEARCH_INITIALIZED = "Textractor: ricerca inizializzata con %zd ganci";
	MAKE_GAME_PROCESS_TEXT = "Textractor: clicca intorno al gioco per forzarlo nel testo del processo durante i prossimi %d secondi";
	HOOK_SEARCH_FINISHED = "ricerca ganci conclusa, %d risultati trovati";
	OUT_OF_RECORDS_RETRY = "registri di ricerca esauriti, riprova se i risultati sono scarsi (conto registri di base aumentato)";
	FUNC_MISSING = "Textractor: funzione non presente";
	MODULE_MISSING = "Textractor: modulo non presente";
	GARBAGE_MEMORY = "Textractor: memoria è in costante cambiamento, inutila la lettura";
	SEND_ERROR = "Textractor: Send ERROR (probabilmente un H-code incorretto)";
	READ_ERROR = "Textractor: Reader ERROR (probabilmente un R-code incorretto)";
	HIJACK_ERROR = "Textractor: ERRORE di Hijack";
	COULD_NOT_FIND = "Textractor: impossibile trovare il testo";
	TRANSLATE_TO = "Traduci a";
	TRANSLATE_SELECTED_THREAD_ONLY = "Traduci solo il thread del testo selezionato";
	RATE_LIMIT_ALL_THREADS = "Rate limit tutti i thread del testo";
	RATE_LIMIT_SELECTED_THREAD = "Rate limit thread del testo selezionato";
	USE_TRANS_CACHE = "Utilizza la cache di traduzione";
	MAX_TRANSLATIONS_IN_TIMESPAN = "Numero di token del Rate Limit";
	TIMESPAN = "Token del rate limit ripristina il ritardo (ms)";
	...
	USE_PREV_SENTENCE_CONTEXT = "Utilizza la precedente sentenza come contesto";
	API_KEY = "Chiave API";
	EXTRA_WINDOW_INFO = R"(Tasto destro per cambiare le impostazioni
Clicca e trascina i bordi della finestra per muoverla, oppure nell'angolo in basso a destra per ridimensionare)";
	MAX_SENTENCE_SIZE = "Dimensione massima sentenza";
	TOPMOST = "Sempre in primo piano";
	DICTIONARY = "Dizionario";
	DICTIONARY_INSTRUCTIONS = R"(Questo file è utilizzato solo per la funzione "Dizionario" dell'estenzione Extra Window.
...
Questo file deve essere codificato in UTF-8.)";
	SHOW_ORIGINAL = "Testo originale";
	SHOW_ORIGINAL_INFO = R"(Testo originale non sarà mostrato
Funziona solo se questa estenzione è usata direttamente dopo un'estensione di traduzione)";
	ORIGINAL_AFTER_TRANSLATION = "Mostra testo originale dopo traduzione";
	SIZE_LOCK = "Lock delle dimensione";
	POSITION_LOCK = "Lock delle posizione";
	CENTERED_TEXT = "Testo centrato";
	AUTO_RESIZE_WINDOW_HEIGHT = "Auto resize altezza finestra";
	CLICK_THROUGH = "Clicca attraverso\tAlt+X";
	HIDE_MOUSEOVER = "Nascondi testo mouseover";
	OPACITY = "Opacità";
	BG_COLOR = "Colore dello sfondo";
	TEXT_COLOR = "Colore del testo";
	TEXT_OUTLINE = "Contorno del testo";
	OUTLINE_COLOR = "Colore del contorno";
	OUTLINE_SIZE = "Dimensione del contorno";
	OUTLINE_SIZE_INFO = "Dimensione in pixel (consigliato di rimanere sotto il 20% della dimensione del font)";
	FONT = "Font";
	LUA_INTRO = R"(--[[
...
function ProcessSentence(sentence, sentenceInfo)
  --Tuo codice qui...
	...
	LOAD_SCRIPT = "Carica script";
	LUA_ERROR = L"Errore Lua: %s";
	REGEX_FILTER = "Filtro regex";
	INVALID_REGEX = "Regex non valido";
	CURRENT_FILTER = "Filtraggio attuale: %1";
...
Apprendere, creare e testare Espressioni Regolari: https://regexr.com/)";
	THREAD_LINKER = "Collegatore di thread";
	LINK = "Collegamento";
	THREAD_LINK_FROM = "Numero di thread da cui collegarsi";
	THREAD_LINK_TO = "Numero di thread a cui collegarsi";
	HEXADECIMAL = "Esadecimale";
#endif // ITALIAN

#ifdef PORTUGUESE
	NATIVE_LANGUAGE = "Portuguese";
	ATTACH = "Anexar ao Jogo";
	LAUNCH = "Iniciar Jogo";
	DETACH = "Desconectar do Jogo";
	ADD_HOOK = "Adicionar um Hook";
	SAVE_HOOKS = "Salvar Hook(s)";
	SETTINGS = "Opções";
	EXTENSIONS = "Extensões";
	SELECT_PROCESS = "Selecionar Processo";
	ATTACH_INFO = R"(Se você não encontrar o processo o qual deseja anexar a, tente iniciar com permissão de Administrador. Você também pode digitar a ID do processo)";
	FROM_COMPUTER = "Busque no Computador";
	PROCESSES = "Executaveis (*.exe)";
	SAVE_SETTINGS = "Salvar opções";
	EXTEN_WINDOW_INSTRUCTIONS = R"(Arraste e solte a extensão (.dll) aqui para adicioná-la.
...
Pressione delete com uma extensão selecionada para removê-la.)";
	INVALID_EXTENSION = "%1 não é uma extensão válida.";
	CONFIRM_EXTENSION_OVERWRITE = "Outra versão dessa extensão já existe, você gostaria de deletar e reescrevê-la?";
	EXTENSION_WRITE_ERROR = "Falha na gravação da extensão";
	USE_JP_LOCALE = "Emular o idioma Japonês?";
	SHOW_SYSTEM_PROCESSES = "Mostrar Processos do sistema";
	DEFAULT_CODEPAGE = "página de código padrão";
	FLUSH_DELAY = "Delay do Flush";
...
Se você gostou desse projeto, divulgue a todos :))";
	...
	PIPE_CONNECTED = "Textractor: pipe conectado";
	INSERTING_HOOK = "Textractor: inserindo hook: %s";
	REMOVING_HOOK = "Textractor: removendo hook: %s";
	HOOK_FAILED = "Textractor: falha na inserção do hook";
	TOO_MANY_HOOKS = "Textractor: há hooks de mais: não é possível inserir mais";
	HOOK_SEARCH_STARTING = "Textractor: iniciando busca ";
	NOT_ENOUGH_TEXT = "Textractor: não há texto suficiente para uma buscar precisa";
	HOOK_SEARCH_INITIALIZED = "Textractor: busca inicializada com %zd hooks";
	HOOK_SEARCH_FINISHED = "Textractor: busca por hooks finalizada, %d resultados encontrados";
	FUNC_MISSING = "Textractor: função não encontrada";
	MODULE_MISSING = "Textractor: módulo não presente";
	SEND_ERROR = "Textractor: ERRO no envio (provavelmente um H-code incorreto)";
	READ_ERROR = "Textractor:  ERRO na leitura (provavelmente um R-code incorreto)";
	COULD_NOT_FIND = "Textractor: não foi possível encontrar texto";
	...
	EXTRA_WINDOW_INFO = R"(Clique com o botão direito para mudar as opções
Clique e arraste nas beiradas da janela para mover, ou no canto inferior direito para redimessionar)";
	TOPMOST = "Sempre em cima";
	SHOW_ORIGINAL = "Texto original";
	SHOW_ORIGINAL_INFO = R"(Texto original não será mostrado
Apenas funciona se essa extensão for usada diretamente após uma extensão de tradução)";
	SIZE_LOCK = "Travar o Tamanho";
	BG_COLOR = "Cor de fundo";
	TEXT_COLOR = "Cor do Texto";
	FONT = "Fonte";
	REGEX_FILTER = "Fíltro regex";
	INVALID_REGEX = "Regex inválido";
	CURRENT_FILTER = "Atualmente filtrando: %1";
...
Esse arquívo deve ser codifícado em (UTF-16 little endian).)";
	THREAD_LINKER = "Ligador de Threads";
	LINK = "Ligar";
	THREAD_LINK_FROM = "Número do thread para ligar de";
	THREAD_LINK_TO = "Número do thread para ligar para";
#endif // PORTUGUESE
	...
	ATTACH = "เชื่อมเกม";
	LAUNCH = "เริ่มเกม";
	DETACH = "ยกเลิกการเชื่อม";
	ADD_HOOK = "เพิ่มตัวเกี่ยว";
	SAVE_HOOKS = "บันทึกตัวเกี่ยว";
	SETTINGS = "ตั่งค่า";
	EXTENSIONS = "ส่วนขยาย";
	SELECT_PROCESS = "เลือก process";
	ATTACH_INFO = R"(ถ้าไม่สามารถเลือก process ที่ต้องการจะเชื่อม, ลองเปิดโปรแกรมโดยให้สิทธิผู้ดูแลระบบ)";
	FROM_COMPUTER = "เลือกจากเครื่องของคุณ";
	PROCESSES = "Process(ระบบดำเนินการ) (*.exe)";
	SAVE_SETTINGS = "บันทึกการตั่งค่า";
	EXTEN_WINDOW_INSTRUCTIONS = R"(เพื่อที่จะเพิ่มส่วนขยาย คลิกขวาที่ตารางส่วนขยาย หรือ ลากและวางส่วนขยายจากคอมพิวเตอร์ของคุณ, ถ้าหากต้องการเรียงส่วนขยาย ลากและวางข้อมูลภายในตารางเพื่อเรียง ส่วนขยายมีลำดับการแสดงผลจากบนลงล่าง)";
	USE_JP_LOCALE = "ต้องการรันในระบบปฏิบัติการญีั่ปุุ่นหรือไม่?";
	DEFAULT_CODEPAGE = "หน้าโปรแกรมเดิม";
	FLUSH_DELAY = "ช่่วงระหว่างการล้างข้อมูล";
	MAX_BUFFER_SIZE = "ขนาดที่พักข้อมูลสูงสุด";
	CONSOLE = L"แผงควบคุม";
...
Source code สามารถหาได้จากส่วนของ GPLv3 ที่หน้าหลักของเว็บไซต์)";
	...
	PIPE_CONNECTED = "Textractor: เชื่อมต่อกับจุดเชื่อมข้อมูลแล้ว";
	INSERTING_HOOK = "Textractor: ติดตั่งตัวเชื่อม: %s";
	REMOVING_HOOK = "Textractor: ถอดตัวเชื่อม: %s";
	HOOK_FAILED = "Textractor: ใส่ตัวเชื่อมล้มเหลว";
	TOO_MANY_HOOKS = "Textractor: ตัวเชื่อมมากเกินไป: ไม่สามารถใส่ตัวเชื่อมได้";
	NOT_ENOUGH_TEXT = "Textractor: ข้อมูลตัวอักษรไม่มากพอที่จะค้นหาตัวเชื่อม";
	FUNC_MISSING = "Textractor: ไม่พบฟังก์ชั่น";
	MODULE_MISSING = "Textractor: ไม่พบ module";
	GARBAGE_MEMORY = "Textractor: ข้อมูลเปลี่ยนอย่างต่อเนื่อง ไม่สามารถอ่านได้";
	SEND_ERROR = "Textractor: Send ERROR (คาดว่าเป็นความผิดพลาดของ H-Code)";
	READ_ERROR = "Textractor: Reader ERROR (คาดว่าเป็นความผิดพลาดของ R-Code)";
	HIJACK_ERROR = "Textractor: Hijack ERROR";
	COULD_NOT_FIND = "Textractor: ไม่สามารถหาข้อมูลตัวอักษรได้";
	...
	EXTRA_WINDOW_INFO = R"(คลิกขวาเพื่อที่จะตั่งค่า 
คลิกและลากทางขวาบนของหน้าต่างเพื่อควบคุมหน้าต่าง หรือ ขวาล่างเพื่อที่จะปรับขนาด)";
	BG_COLOR = "สีพื่นหลัง";
	TEXT_COLOR = "สีตัวอักษร";
	TOPMOST = "หน้าต่างอยู่บนโปรแกรมอื่น";
	SHOW_ORIGINAL = "ข้อความดังเดิมก่อนแปลภาษา";
	SIZE_LOCK = "ปรับให้ไม่สามารถเปลี่ยนขนาดได้";
	FONT = "ฟ้อนต์";
#endif // THAI
	...
	FORGET = "게임 저장정보 삭제";
	ADD_HOOK = "후킹주소 추가";
	REMOVE_HOOKS = "후킹주소 삭제";
	SAVE_HOOKS = "후킹주소 저장";
	SEARCH_FOR_HOOKS = "후킹주소 찾기";
	SETTINGS = "설정";
	EXTENSIONS = "확장기능";
	SELECT_PROCESS = "프로세스 선택";
	ATTACH_INFO = R"(부착하려는 게임이 보이지 않는다면, 관리자 권한으로 실행해보세요. 프로세스 ID를 입력 할 수도 있습니다.)";
	SELECT_PROCESS_INFO = "직접 프로세스파일 이름을 타이핑한다면, 정확한 경로를 입력하세요";
	FROM_COMPUTER = "컴퓨터로부터 선택";
	PROCESSES = "프로세스 (*.exe)";
	SAVE_SETTINGS = "설정 저장";
	EXTEN_WINDOW_INSTRUCTIONS = R"(확장기능을 추가하려면 리스트에서 오른쪽 클릭하거나 
		폴더에서 드래그하세요.
확장기능 순서를 변경하려면 리스트에서 드래그합니다.
(확장기능은 위부터 순서대로 작동합니다.)
확장기능을 삭제하려면 delete 를 누르세요.)";
	ADD_EXTENSION = "확장기능 추가";
	INVALID_EXTENSION = "%1 은 유효하지 않은 확장기능입니다.";
	CONFIRM_EXTENSION_OVERWRITE = "다른버전의 동일한 확장기능이 존재합니다. 덮어씌우시겠습니까?";
	EXTENSION_WRITE_ERROR = "확장기능을 저장하는데 실패하였습니다.";
	USE_JP_LOCALE = "일본어 로케일로 에뮬레이트합니까?";
	HOOK_SEARCH_UNSTABLE_WARNING = "후킹주소 찾기는 불안정합니다! 게임의 강제종료에 대비하세요!";
	SEARCH_CJK = "한국어/일본어/중국어 찾기";
	CODEPAGE = "코드페이지";
	SEARCH_FOR_TEXT = "특정 텍스트 찾기";
	START_HOOK_SEARCH = "주소찾기 시작";
	SAVE_SEARCH_RESULTS = "찾기결과 저장";
	DOUBLE_CLICK_TO_REMOVE_HOOK = "더블클릭으로 주소 제거";
	FILTER_REPETITION = "반복문 필터";
	AUTO_ATTACH = "자동 부착";
	ATTACH_SAVED_ONLY = "자동 부착 (저장된 게임만)";
	SHOW_SYSTEM_PROCESSES = "시스템 프로세스 보기";
	DEFAULT_CODEPAGE = "기본 코드페이지";
	FLUSH_DELAY = "플러시 딜레이";
	...
	EXTRA_WINDOW_INFO = R"(오른쪽 클릭으로 설정변경
드래그로 창 이동이 가능하고, 오른쪽 모서리에서 크기조절이 가능)";
	TOPMOST = "항상 위";
	SHOW_ORIGINAL = "원문";
	SHOW_ORIGINAL_INFO = R"(원문이 출력되지 않음
이 확장기능이 번역확장기능 이후에 사용될때만 동작함)";
	...
	FONT = "폰트";
	REGEX_FILTER = "정규식 필터";
	INVALID_REGEX = "유효하지 않은 정규식";
	CURRENT_FILTER = "현재 필터중: %1";
...
이 파일은 유니코드로 저장되어야만 함 (UTF-16 little endian).)";
	...
	ATTACH = "Attacher le jeu";
	LAUNCH = "Lancer le jeu";
	CONFIG = "Configure le jeu";
	DETACH = "Detacher du jeu";
	FORGET = "Oublier le jeu";
	ADD_HOOK = "Ajouter un hook";
	REMOVE_HOOKS = "Enlever un hook(s)";
	SAVE_HOOKS = "Sauvegarder un hook(s)";
	SEARCH_FOR_HOOKS = "Rechercher des hooks";
	SETTINGS = "Paramètres";
	EXTENSIONS = "Extensions";
	SELECT_PROCESS = "Selectionner le processus";
	ATTACH_INFO = R"(Si vous ne voyez pas le processus que vous souhaitez joindre, essayez de l'exécuter avec les droits d'administrateur
Vous pouvez également saisir l'ID de processus)";
	SELECT_PROCESS_INFO = "Si vous saisissez manuellement le nom du fichier de processus, veuillez utiliser le chemin exact";
	FROM_COMPUTER = "Sélectionner depuis l'ordinateur";
	PROCESSES = "Processus (*.exe)";
	CODE_INFODUMP = R"(Entrez le read code
R{S|Q|V|M}[null_length<][codepage#]@addr
OU
Entrez le hook code
H{A|B|W|H|S|Q|V|M}[F][null_length<][N][codepage#][padding+]data_offset[*deref_offset][:split_offset[*deref_offset]]@addr[:module[:func]]
...
* means dereference pointer+deref_offset)";
	SAVE_SETTINGS = "Sauvergarder les paramètres";
	EXTEN_WINDOW_INSTRUCTIONS = R"(Pour ajouter une extension, cliquez avec le bouton droit sur la liste des extensions
...
Pour supprimer une extension, sélectionnez-la et appuyez sur supprimer)";
	...
	INVALID_EXTENSION = "%1 C'est une extension invalide";
	CONFIRM_EXTENSION_OVERWRITE = "Une autre version de cette extension existe déjà. Voulez-vous la supprimer et la remplacer?";
	EXTENSION_WRITE_ERROR = "Impossible d'enregistrer l'extension";
	USE_JP_LOCALE = "Émuler les paramètres régionaux japonais?";
	FAILED_TO_CREATE_CONFIG_FILE = "Impossible de créer le fichier de configuration \"%1\"";
	HOOK_SEARCH_UNSTABLE_WARNING = "La recherche de crochets est instable! Soyez prêt à ce que votre jeu plante!";
	SEARCH_CJK = "Rechercher pour Chinois/Japonais/Coréen";
	SEARCH_PATTERN = "Modèle de recherche (tableau d'octets hexadécimaux)";
	SEARCH_DURATION = "Durée de la recherche (ms)";
	SEARCH_MODULE = "Recherche sans module";
	PATTERN_OFFSET = "Décalage par rapport au début du modèle";
	MAX_HOOK_SEARCH_RECORDS = "Limite du résultat de la recherche";
	MIN_ADDRESS = "Minimum d'adresses (hex)";
	MAX_ADDRESS = "Maximum d'adresses (hex)";
	STRING_OFFSET = "Décalage de la chaîne (hex)";
	HOOK_SEARCH_FILTER = "Les résultats doivent correspondre à ce regex";
	TEXT = "Texte";
	CODEPAGE = "Code de page";
	SEARCH_FOR_TEXT = "Rechercher un texte spécifique";
	START_HOOK_SEARCH = "Lancer la recherche de hook";
	SAVE_SEARCH_RESULTS = "Sauvergarder les résultats de la recherche";
	TEXT_FILES = "Texte (*.txt)";
	DOUBLE_CLICK_TO_REMOVE_HOOK = "Double cliquer sur un hook pour l'enlever";
	FILTER_REPETITION = "Répétition de filtre";
	AUTO_ATTACH = "Attachement Automatique";
	ATTACH_SAVED_ONLY = "Attachement Automatique (Sauvergardé seulement)";
	SHOW_SYSTEM_PROCESSES = "Montrer les processus système";
	DEFAULT_CODEPAGE = "Page de code de base";
	FLUSH_DELAY = "Retard de vidage";
	MAX_BUFFER_SIZE = "Taille maximale du tampon";
	MAX_HISTORY_SIZE = "Taille d'historique maximale";
	CONFIG_JP_LOCALE = "Lancement avec les paramètres régionaux JP";
	CONSOLE = L"Console";
...
example: Textractor -p4466 -p"My Game.exe" tries to inject processes with ID 4466 or with name My Game.exe)";
	...
	PIPE_CONNECTED = "Textractor: tuyau connecté";
	INSERTING_HOOK = "Textractor: insertion du hook: %s";
	REMOVING_HOOK = "Textractor: enlève le hook: %s";
	HOOK_FAILED = "Textractor: n'a pas réussi à insérer un hook";
	TOO_MANY_HOOKS = "Textractor: trop de hooks: impossible d'insérer";
	HOOK_SEARCH_STARTING = "Textractor: démarrage de la recherche";
	NOT_ENOUGH_TEXT = "Textractor: pas assez de texte pour effectuer une recherche précise";
	HOOK_SEARCH_INITIALIZED = "Textractor: la recherche a été initialisé avec %zd hooks";
	MAKE_GAME_PROCESS_TEXT = "Textractor: veuillez cliquer dans le jeu pour le forcer à traiter le texte lors de la prochaine %d seconds";
	HOOK_SEARCH_FINISHED = "Textractor: la recherche du hook est finie, %d results found";
	OUT_OF_RECORDS_RETRY = "Textractor: hors des enregistrements de recherche, veuillez réessayer si les résultats sont médiocres (le nombre d'enregistrements par défaut a augmenté)";
	FUNC_MISSING = "Textractor: function non présente";
	MODULE_MISSING = "Textractor: module non présente";
	GARBAGE_MEMORY = "Textractor: mémoire en constante évolution, inutile à lire";
	SEND_ERROR = "Textractor: envoyer ERREUR (comme un H-code instable/incorrect)";
	READ_ERROR = "Textractor: Lire ERREUR (comme un R-code incorrect)";
	HIJACK_ERROR = "Textractor: ERREUR Hijack";
	COULD_NOT_FIND = "Textractor: ne peut pas trouver le texte";
	TRANSLATE_TO = "Traduire à";
	TRANSLATE_SELECTED_THREAD_ONLY = "Traduire uniquement le thread sélectionné";
	RATE_LIMIT_ALL_THREADS = "Taux limite tout les threads de texte";
	RATE_LIMIT_SELECTED_THREAD = "Limite de débit du thread de texte sélectionné";
	USE_TRANS_CACHE = "Utiliser le cache de traduction";
	MAX_TRANSLATIONS_IN_TIMESPAN = "Nombre de tokens du limiteur de débit";
	TIMESPAN = "Délai de restauration du token du limiteur de débit (ms)";
	...
	USE_PREV_SENTENCE_CONTEXT = "Utiliser la phrase précédente comme contexte";
	API_KEY = "API key";
	EXTRA_WINDOW_INFO = R"(Clic droit pour modifier les paramètres
Cliquez et faites glisser sur les bords de la fenêtre pour vous déplacer ou dans le coin inférieur droit pour redimensionner)";
	MAX_SENTENCE_SIZE = "Taille maximale de la phrase";
	TOPMOST = "Toujours au dessus";
	DICTIONARY = "Dictionnaire";
	DICTIONARY_INSTRUCTIONS = R"(Ce fichier est utilisé uniquement pour la fonction "Dictionnaire" de l'extension Extra Window.
...
Ce fichier doit être encodé en UTF-8.)";
	SHOW_ORIGINAL = "Texte Original";
	SHOW_ORIGINAL_INFO = R"(Le texte d'origine ne sera pas affiché
Fonctionne uniquement si cette extension est utilisée directement après une extension de traduction)";
	SIZE_LOCK = "Verouiller la taille";
	OPACITY = "Opacité";
	BG_COLOR = "Couleur d'arrière-plan";
	TEXT_COLOR = "Couleur du texte";
	TEXT_OUTLINE = "Contour du texte";
	OUTLINE_COLOR = "Couleur du contour";
	OUTLINE_SIZE = "Taille du contour";
	OUTLINE_SIZE_INFO = "Taille en pixels (recommandé de rester en dessous de 20% de la taille de la police)";
	FONT = "Police";
	LUA_INTRO = R"(--[[
...
function ProcessSentence(sentence, sentenceInfo)
  --Your code here...
	...
	LOAD_SCRIPT = "Charger le script";
	LUA_ERROR = L"Erreur Lua: %s";
	REGEX_FILTER = "Filtre regex";
	INVALID_REGEX = "Regex invalide";
	CURRENT_FILTER = "En train de filtrer: %1";
...
Ce fichier doit être encodé en Unicode (UTF-16 Little Endian).)";
	THREAD_LINKER = "Lien du thread";
	LINK = "Lien";
	THREAD_LINK_FROM = "Nombre du thread du lien depuis";
	THREAD_LINK_TO = "Nombre du thread du lien a";
